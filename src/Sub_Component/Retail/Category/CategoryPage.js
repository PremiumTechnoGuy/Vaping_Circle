            ...
            >
              <div id="content" class="">
                <div className="item e6">
                  ...
                  />
                  <button
                    class=" p-3 left-[2rem] lg:left-[4rem] right-[2rem]  md:w-44 absolute shadow-md bg-white font-bold text-[14px] md:fs-6 rounded-md text-[#59A0B8] bottom-[2rem] md:bottom-[3rem] z-5"
                  >
                    {item.name}
                  </button>
                </div>
