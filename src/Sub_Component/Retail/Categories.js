            ...
            <Col>
              <Row style={{ position: "relative" }}>
                ...
                >
                  ...
                  />{" "}
                  {/* <div class=""> */}
                  <button onClick={() => setCurrentCategory(categories[1]?._id)} class=" absolute bottom-[3rem] left-[2rem]  z-5 text-[12px] py-2 px-2 bg-white font-bold shadow-md  w-[118px] ml-[10px] rounded-md text-[#59A0B8]">
                    {categories[1]?.name || "Refill"}
                  </button>
                  {/* </div> */}
                </Link>
              </Row>
              <Row style={{ position: "relative" }}>
                ...
                >
                  <img
                    ...
                    src="https://ik.imagekit.io/p2slevyg1/refill.png?updatedAt=1704225483845"
                  />{" "}
                  <button onClick={() => setCurrentCategory(categories[2]?._id)} class=" absolute bottom-[3rem] left-[3rem] w-[100px] z-5  bg-white font-bold shadow-md text-sm py-2 px-3 rounded-md text-[#59A0B8]">
                    {categories[2]?.name || "Mods"}
          ...
          <Row style={{ position: "relative" }}>
            ...
            >
              ...
              <div class="absolute bottom-[3rem] left-[9rem] w-0">
                <button onClick={() => setCurrentCategory(categories[3]?._id)} class="text-sm py-2 px-3 z-5  bg-white font-bold shadow-md  rounded-md text-[#59A0B8]">
                  {categories[3]?.name || "Disposables"}
