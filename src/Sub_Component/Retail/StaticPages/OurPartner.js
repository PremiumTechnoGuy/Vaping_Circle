            ...
            <div class="mt-[7rem] md:mt-[13rem] ">
                ...
                <div class="mx-5 md:mx-5 mt-5  md:px-5 ">
                    ...
                    <p class="text-[#575757] tracking-wide leading-6 fs-5">
                        ...
                        e-liquids, kits, and <span style={{ color: 'blue' }}><Link target="_blank"
                            class="hover:text-black"
                            to="/fusion_vape">much more</Link></span>.
                    </p>
                </div>
                ...
                <div class="mx-5 md:mx-5 mt-5  md:px-5 ">
                    ...
                    >
                        ...
                        <p class="fs-5 text-black font-semibold ">
                            Address: 194 Mansfield Rd., Little Chester,
                            Derby DE1 3RB.
                        </p>
                    </Link>
                    <p class="text-[#575757] tracking-wide leading-6 fs-5">
                        Step into our Derby store and immerse yourself in a relaxed environment where you can explore
                        the diverse range of products, including premium vape juices, electronic cigarette starter kits,
                        tanks, mods, and an assortment of accessories.

                        and <span style={{ color: 'blue' }}><Link target="_blank"
                            class="hover:text-black"
                            to="/cloud_partner">much more</Link></span>.
                    </p>
                </div>
                <div class="mx-5 md:mx-5 mt-5  md:px-5 ">
