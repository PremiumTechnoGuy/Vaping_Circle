...
const Cloud_Partner = ({ categories, filters }) => {
  return (
    <div>
      <div class="mt-[7rem] md:mt-[13rem] ">
        ...
        <h1 class="fs-1 font-bold flex justify-center items-center text-white text-center gradident_bg h-[10rem] md:h-[15rem]">
          Our Partner <br />
          Cloud 194 - Derby Store
        </h1>
        <div class="mx-5 md:mx-5 mt-5  md:px-5 ">
          <p class="text-[#575757] tracking-wide leading-6 fs-5">
            Indulge in the world of electronic cigarettes and an extensive array
            of vape liquids at our Derby outlet, Cloud 194. Discover a haven for
            both novice vapers and seasoned enthusiasts. Our committed team is
            dedicated to providing top-notch customer service, ensuring that all
            your inquiries and concerns are met with expertise and care.
          </p>
        </div>
        <div class="mx-5 md:mx-5 mt-5  md:px-5 ">
          <p class="fs-4 text-black font-semibold line">Cloud 194</p>
          <p class="text-[#575757] tracking-wide leading-6 mb-2 fs-5">
            ...
            tanks, mods, and an assortment of accessories.
          </p>
        </div>
        <div class="mx-5 md:mx-5 mt-5  md:px-5  ">
